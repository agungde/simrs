...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="add"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">View Detil  Kamar Bersalin</h4>
                    <div class=""><?php
                        ...
                        $queryb = mysqli_query($koneksi, "select * from data_kamar_bersalin WHERE id_data_kamar_bersalin='$fromdata'")
                        ...
                        if(isset($_POST[$post])){
                        if($_POST[$post]==""){}else{
                        mysqli_query($koneksi,"UPDATE data_ranjang_bersalin SET no_$nom='isi' WHERE id_data_kamar='$fromdata'");
                        mysqli_query($koneksi,"UPDATE ranap_bersalin SET no_ranjang='No $nom' WHERE id='$original_plaintext'");
                        }
                        }
                        }
                        // mysqli_query($koneksi,"INSERT INTO `data_ranjang` (`jumlah_ranjang`,`id_data_kamar`) VALUES ('$jumlah_ranjang','$rec_id')"); 
                        mysqli_query($koneksi,"UPDATE ranap_bersalin SET kamar_kelas='".$data['kamar_kelas']."', nama_kamar='".$data['nama_kamar']."', no_kamar='".$data['no_kamar']."' WHERE id='$original_plaintext'");
                        $terisiplus=$terisi + 1;
                        $siasa=$jumranjang - $terisiplus;
                        mysqli_query($koneksi,"UPDATE data_kamar_bersalin SET sisa='$siasa', terisi='$terisiplus' WHERE id_data_kamar_bersalin='$fromdata'");
                        ?>
            ...
            <div class="row ">
                <div class="col-md-9 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        ...
                        <form id="data_kamar_bersalin-detile-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="<?php print_link("data_kamar_bersalin/detile?csrf_token=$csrf_token") ?>" method="post">
                            <div>
                                <?php
                                $usrnam  = "".USER_NAME;
                                $id_user = "".USER_ID;
                                    ...
                                    <table class="table table-hover table-borderless table-striped">
                                        ...
                                        <tr  class="td-nama_kamar">
                                            ...
                                            <td class="value">
                                                <span >
                                                    ...
                                                    $dbname  = "".DB_NAME;
                                                    $koneksi = new mysqli($dbhost, $dbuser,$dbpass, $dbname);
                                                    $sqlcek1 = mysqli_query($koneksi,"select * from nama_kamar_ranap_bersalin WHERE id='".$data['nama_kamar']."'");
                                        ...
                                        <tr  class="td-harga">
                                            ...
                                            <td class="value"><?php 
                                                ...
                                                $hargakamarber=$row['harga_ranap_bersalin'];
                                                }
                                ...
                                <div id="page-report-body" class="table-responsive">
                                    <table class="table  table-striped table-sm text-left">
                                        <thead class="table-header bg-success text-dark"><tr><input value="<?php echo $precord;?>" type="hidden" name="precord" ><input value="<?php echo $fromdata;?>" type="hidden" name="fromdata"><?php
                                            $jumranjang=$data['jumlah_ranjang'];
                                            $rec_id=$data['id_data_kamar_bersalin'];
                                            $Query = "SELECT * FROM data_ranjang_bersalin WHERE id_data_kamar='$rec_id'";
