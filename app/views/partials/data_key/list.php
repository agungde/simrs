...
<section class="page ajax-page" id="<?php echo $page_element_id; ?>" data-page-type="list"  data-display-type="table" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-white p-1 mb-1">
        <div class="container-fluid">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Data Key</h4>
                </div>
                <div class="col-sm-3 ">
                    <div class=""><div><?php
                        $id_user = "".USER_ID;
                        ...
                        $sql = mysqli_query($koneksi,"select * from data_key WHERE nama='$id_user'");
                        $rod = mysqli_num_rows($sql);
                        if ($rod <> 0) {  
                        }else{
                        ?>
                        <a  class="btn btn btn-primary my-1" href="<?php print_link("data_key/add"); ?>">
