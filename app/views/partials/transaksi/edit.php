                                                        ...
                                                        <div class="form-group ">
                                                            ...
                                                            <div class="form-group ">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-8">
                                                                        <div class="">
                                                                            <input id="ctrl-poli"  value="<?php  echo $data['poli']; ?>" type="text" placeholder="Enter Poli"  required="" name="poli"  class="form-control " />
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                    ...
                                                                    <div class="form-group ">
                                                                        ...
                                                                        <div class="form-group ">
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-sm-8">
                                                                                    <div class="">
                                                                                        <input id="ctrl-deposit"  value="<?php  echo $data['deposit']; ?>" type="number" placeholder="Enter Deposit" step="1"  required="" name="deposit"  class="form-control " />
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group ">
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-sm-8">
                                                                                        <div class="">
                                                                                            <input id="ctrl-sisa_tagihan"  value="<?php  echo $data['sisa_tagihan']; ?>" type="number" placeholder="Enter Sisa Tagihan" step="1"  required="" name="sisa_tagihan"  class="form-control " />
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                    ...
                                                                                    <div class="form-group ">
                                                                                        ...
                                                                                        <div class="form-group ">
                                                                                            <div class="row">
                                                                                                ...
                                                                                                <div class="col-sm-8">
                                                                                                    <div class="">
                                                                                                        <input id="ctrl-setatus_tagihan"  value="<?php  echo $data['setatus_tagihan']; ?>" type="text" placeholder="Enter Setatus Tagihan"  required="" name="setatus_tagihan"  class="form-control " />
                                                                                                        </div>
                                                                                                    </div>
                                                                                                </div>
                                                                                            </div>
                                                                                            <div class="form-group ">
                                                                                                <div class="row">
                                                                                                    ...
                                                                                                    <div class="col-sm-8">
                                                                                                        <div class="">
                                                                                                            <input id="ctrl-transaksi"  value="<?php  echo $data['transaksi']; ?>" type="text" placeholder="Enter Transaksi"  required="" name="transaksi"  class="form-control " />
                                                                                                            </div>
                                                                                                        </div>
                                                                                                    </div>
                                                                                                </div>
                                                                                                            ...
                                                                                                            <div class="form-group ">
                                                                                                                ...
                                                                                                                <div class="form-group ">
                                                                                                                    <div class="row">
                                                                                                                        ...
                                                                                                                        <div class="col-sm-8">
                                                                                                                            <div class="">
                                                                                                                                <input id="ctrl-kas_akhir"  value="<?php  echo $data['kas_akhir']; ?>" type="number" placeholder="Enter Kas Akhir" step="1"  required="" name="kas_akhir"  class="form-control " />
                                                                                                                                </div>
                                                                                                                            </div>
                                                                                                                        </div>
                                                                                                                    </div>
