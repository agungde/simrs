                ...
                <div class="row ">
                    <div class="col-md-12 comp-grid">
                        ...
                        <div  class=" animated fadeIn page-content">
                            ...
                            <div id="transaksi-bpjs-records">
                                <div id="page-report-body" class="table-responsive">
                                    <div><iframe src="https://pcarejkn.bpjs-kesehatan.go.id/eclaim/" width="100%" height="100%" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe></div>
                                </div>
                            </div>
                        </div>
                    </div>
