...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="list"  data-display-type="table" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container-fluid">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Catatan Medis</h4>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row ">
                <div class="col-md-12 comp-grid">
                    ...
                    <div  class=" animated fadeIn page-content">
                        <div id="catatan_medis-list-records">
                                    ...
                                    <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                        ...
                                        <tr>
                                            ...
                                            <td class="td-nama_poli"> <span><?php 
                                                ...
                                                $querydt = mysqli_query($koneksi, "SELECT * from data_poli WHERE id_poli='$idpol'")
                                                or die('Ada kesalahan pada query tampil data : ' . mysqli_error($koneksi));
                                                $rowsdt = mysqli_num_rows($querydt);
                                                if ($rowsdt <> 0) { 
                                                $datp= mysqli_fetch_assoc($querydt);
                                                echo $datp['nama_poli'];
                                                }else{
                                                echo $data['nama_poli'];
                                                }
                                            ...
                                            <td class="td-dokter"><span><?php 
                                                $iddok= $data['dokter'];
                                                $querydt = mysqli_query($koneksi, "SELECT * from data_dokter WHERE id_dokter='$iddok'")
                                                or die('Ada kesalahan pada query tampil data : ' . mysqli_error($koneksi));
                                                $rowsdt = mysqli_num_rows($querydt);
                                                if ($rowsdt <> 0) { 
                                                $datp= mysqli_fetch_assoc($querydt);
                                                echo $datp['nama_dokter'];
                                                }else{
                                                echo $data['dokter'];;
                                                }
                                            // echo $data['nama_poli']; ?></span></td>
