...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="add"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Add New Permintaan Barang Resep</h4>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row ">
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form id="permintaan_barang_resep-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="<?php print_link("permintaan_barang_resep/add?csrf_token=$csrf_token") ?>" method="post">
                            <div>
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-id_transaksi"  value="<?php  echo $this->set_field_value('id_transaksi',""); ?>" type="text" placeholder="Enter Id Transaksi"  required="" name="id_transaksi"  class="form-control " />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                        ...
                                                        <div class="col-sm-8">
                                                            <div class="">
                                                                <select required=""  id="ctrl-category_barang" name="category_barang"  placeholder="Select a value ..."    class="custom-select" >
                                                                    ...
                                                                    <?php 
                                                                    $category_barang_options = $comp_model -> permintaan_barang_resep_category_barang_option_list();
                                                                    ...
                                                                    <div class="form-group ">
                                                                        ...
                                                                        <div class="form-group ">
                                                                            ...
                                                                            <div class="form-group ">
                                                                                <div class="row">
                                                                                    <div class="col-sm-4">
                                                                                        <label class="control-label" for="actiom">Actiom <span class="text-danger">*</span></label>
                                                                                    </div>
                                                                                    <div class="col-sm-8">
                                                                                        <div class="">
                                                                                            <input id="ctrl-actiom"  value="<?php  echo $this->set_field_value('actiom',""); ?>" type="text" placeholder="Enter Actiom"  required="" name="actiom"  class="form-control " />
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
