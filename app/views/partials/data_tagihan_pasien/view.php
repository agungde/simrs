...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="view"  data-display-type="table" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">View  Data Tagihan Pasien</h4>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div id="page-report-body" class="">
                            <table class="table table-hover table-borderless table-striped">
                                ...
                                <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                    ...
                                    <tr  class="td-id_data">
                                        <th class="title"> Id Data: </th>
                                        <td class="value"> <?php echo $data['id_data']; ?></td>
                                    </tr>
                                    <tr  class="td-nama_tagihan">
                                        <th class="title"> Nama Tagihan: </th>
                                        <td class="value"> <?php echo $data['nama_tagihan']; ?></td>
                                    </tr>
                                    <tr  class="td-tanggal">
                                    ...
                                    <tr  class="td-no_tag">
                                        <th class="title"> No Tag: </th>
                                        <td class="value"> <?php echo $data['no_tag']; ?></td>
                                    </tr>
                                </tbody>
                                <!-- Table Body End -->
                            </table>
