...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="add"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Add New Data Tagihan Pasien</h4>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row ">
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form id="data_tagihan_pasien-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="<?php print_link("data_tagihan_pasien/add?csrf_token=$csrf_token") ?>" method="post">
                            <div>
                                <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <label class="control-label" for="id_data">Id Data <span class="text-danger">*</span></label>
                                            </div>
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <input id="ctrl-id_data"  value="<?php  echo $this->set_field_value('id_data',""); ?>" type="number" placeholder="Enter Id Data" step="1"  required="" name="id_data"  class="form-control " />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group ">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <input id="ctrl-nama_tagihan"  value="<?php  echo $this->set_field_value('nama_tagihan',""); ?>" type="text" placeholder="Enter Nama Tagihan"  required="" name="nama_tagihan"  class="form-control " />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                                ...
                                                                <div class="form-group ">
                                                                    ...
                                                                    <div class="form-group ">
                                                                        ...
                                                                        <div class="form-group ">
                                                                            <div class="row">
                                                                                <div class="col-sm-4">
                                                                                    <label class="control-label" for="no_tag">No Tag <span class="text-danger">*</span></label>
                                                                                </div>
                                                                                <div class="col-sm-8">
                                                                                    <div class="">
                                                                                        <input id="ctrl-no_tag"  value="<?php  echo $this->set_field_value('no_tag',""); ?>" type="number" placeholder="Enter No Tag" step="1"  required="" name="no_tag"  class="form-control " />
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
