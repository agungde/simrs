                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="form-group ">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <div class="">
                                                                <input id="ctrl-no_hp"  value="<?php  echo $data['no_hp']; ?>" type="number" placeholder="Enter No Hp" step="1"  name="no_hp"  class="form-control " />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group ">
                                                        ...
                                                        <input id="ctrl-no_rekam_medis"  value="<?php  echo $data['no_rekam_medis']; ?>" type="hidden" placeholder="Enter No Rekam Medis"  name="no_rekam_medis"  class="form-control " />
                                                            <input id="ctrl-setatus"  value="<?php  echo $data['setatus']; ?>" type="hidden" placeholder="Enter Setatus"  required="" name="setatus"  class="form-control " />
                                                                <div class="form-group ">
                                                                    <div class="row">
                                                                        <div class="col-sm-4">
