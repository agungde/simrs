                            ...
                            <div>
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-kode_obat"  value="<?php  echo $this->set_field_value('kode_obat',"Auto"); ?>" type="text" placeholder="Enter Kode Obat"  required="" name="kode_obat"  data-url="api/json/data_obat_kode_obat_value_exist/" data-loading-msg="Checking availability ..." data-available-msg="Available" data-unavailable-msg="Not available" class="form-control  ctrl-check-duplicate" />
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <select required=""  id="ctrl-penggunaan" name="penggunaan"  placeholder="Select a value ..."    class="custom-select" >
                                                        ...
                                                        $value = $option['value'];
                                                        $label = $option['label'];
                                                        $selected = $this->set_field_selected('penggunaan', $value, "");
                                                        ?>
                                    ...
                                    <div class="form-group ">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <input id="ctrl-nama_obat"  value="<?php  echo $this->set_field_value('nama_obat',""); ?>" type="text" placeholder="Enter NAMA OBAT"  required="" name="nama_obat"  data-url="api/json/data_obat_nama_obat_value_exist/" data-loading-msg="Checking availability ..." data-available-msg="Available" data-unavailable-msg="Not available" class="form-control  ctrl-check-duplicate" />
                                                        <div class="check-status"></div> 
                                                    </div>
                                                </div>
                                            </div>
