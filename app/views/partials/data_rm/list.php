...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="list"  data-display-type="table" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="p-1 mb-1">
        <div class="container-fluid">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Data Rm</h4>
                </div>
                <div class="col-sm-4 ">
                    <form  class="search" action="<?php print_link('data_rm'); ?>" method="get">
                            ...
                            <nav class="page-header-breadcrumbs mt-2" aria-label="breadcrumb">
                                <ul class="breadcrumb m-0 p-1">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a class="text-decoration-none" href="<?php print_link('data_rm'); ?>">
                                    ...
                                    <table class="table  table-sm text-left">
                                        <thead class="table-header bg-success text-dark">
                                            <tr>
                                                ...
                                                <th  class="td-pendaftaran_poli"> Pendaftaran Poli</th>
                                                <th  class="td-igd"> Igd</th>
                                        ...
                                        <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                            ...
                                            <tr>
                                                ...
                                                <td class="td-rm_lama"><span>
                                                    ...
                                                    <div class="dropdown" >
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            ...
                                                            <i class="fa fa-plus "></i>Add Uploads RM Lama</a>
                                                            <?php }?>
                                                        </ul>
                                                    </div>
                                                    <?php }}?>
                                                ...
                                                <td class="td-pendaftaran_poli"> <?php echo $data['pendaftaran_poli']; ?></td>
                                                <td class="td-igd"> <?php echo $data['igd']; ?></td>
                                                ...
                                                <td class="page-list-action td-btn">
                                                    <div class="dropdown" >
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            <?php if($can_view){ ?>
                                                            <a class="dropdown-item page-modal" href="<?php print_link("data_rm/view/$rec_id"); ?>">
