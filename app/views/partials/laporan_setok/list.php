    ...
    <div  class="p-2 mb-2">
        <div class="container-fluid">
            <div class="row ">
                ...
                </div><h4 class="record-title">Laporan Stok Actual</h4>
            </div>
            <div class="col-sm-3 ">
                <?php if($can_add){ ?>
                <a  class="btn btn btn-primary my-1" href="<?php print_link("laporan_setok/add") ?>">
            ...
            <div class="col-sm-4 ">
                <form  class="search" action="<?php print_link('laporan_setok'); ?>" method="get">
                        ...
                        <nav class="page-header-breadcrumbs mt-2" aria-label="breadcrumb">
                            <ul class="breadcrumb m-0 p-1">
                                ...
                                <li class="breadcrumb-item">
                                    <a class="text-decoration-none" href="<?php print_link('laporan_setok'); ?>">
            ...
            <div class="row ">
                <div class="col-md-12 comp-grid">
                    ...
                    <div  class=" animated fadeIn page-content">
                        <div id="laporan_setok-list-records">
                                ...
                                <table class="table  table-sm text-left">
                                    <thead class="table-header bg-success">
                                        <tr>
                                            ...
                                            <th  class="td-setok_awal"> Setok Awal</th>
                                            <th  class="td-keluar"> Stok Keluar</th>
                                            <th  class="td-setok"> Stok Actual</th>
                                            <th  class="td-jumlah"> Stok Akhir</th>
                                            <th  class="td-pending_keluar"> Pending  Stok Keluar</th>
                                            <th  class="td-selisih"> Selisih</th>
                                    ...
                                    <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                        ...
                                        <tr>
                                            ...
                                            <td class="td-setok_awal"> <?php echo $data['setok_awal']; ?></td>
                                            <td class="td-keluar"> <span><?php echo $data['keluar']; ?></span></td>
                                            <td class="td-setok"> <?php echo $data['setok']; ?></td>
                                            <td class="td-jumlah"> <span><?php
                                                $jumdatsetok=$data['jumlah'] + $data['pending_keluar'];
                                                echo $jumdatsetok;
                                            ?></span></td>
                                            <td class="td-pending_keluar"> <?php echo $data['pending_keluar']; ?></td>
                                            <td class="td-selisih">  <?php
                                                if($data['selisih'] < 0){
                                                ?>
                                                <span style="border-radius: 8px; background-color:     #DC143C; color: white; padding:5px; font-weight: bold;"><?php echo $data['selisih']; ?></span>
                                                <?php
                                                }else if($data['selisih']=="0"){
                                                ?>
                                                <span style="border-radius: 8px; background-color: green; color: white; padding:5px; font-weight: bold;"><?php echo $data['selisih']; ?></span>
                                                <?php
                                                }else{
                                                ?>
                                                <span ><?php echo $data['selisih']; ?></span>
                                                <?php
                                                }
                                                ?>
                                            </td>
