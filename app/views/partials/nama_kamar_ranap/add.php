...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="add"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class=" p-2 mb-2">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Add New Nama Kamar Ranap</h4>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row ">
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class="p-2 animated fadeIn page-content">
                        <form id="nama_kamar_ranap-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="<?php print_link("nama_kamar_ranap/add?csrf_token=$csrf_token") ?>" method="post">
                            <div>
