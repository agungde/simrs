                        ...
                        <div id="page-report-body" class="">
                            ...
                            <table class="table table-hover table-borderless table-striped">
                                ...
                                <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                    ...
                                    <tr  class="td-debet">
                                        <th class="title"> Debet: </th>
                                        <td class="value">Rp.<?php echo number_format($data['debet'],0,",",".");?></td>
                                    </tr>
                                    <tr  class="td-kredit">
                                        <th class="title"> Kredit: </th>
                                        <td class="value">Rp.<?php echo number_format($data['kredit'],0,",",".");?></td>
                                    </tr>
                                    <tr  class="td-saldo">
                                        <th class="title"> Saldo: </th>
                                        <td class="value">Rp.<?php echo number_format($data['saldo'],0,",",".");?></td>
                                    </tr>
                                    <tr  class="td-kasir">
                                        <th class="title"> Kasir: </th>
                                        <td class="value">
                                    ...
                                    <tr  class="td-kas_awal">
                                        ...
                                        <td class="value">Rp.<?php echo number_format($data['kas_awal'],0,",",".");?></td>
                                    </tr>
                                    ...
                                    <tr  class="td-saldo_cash">
                                        <th class="title"> Saldo Cash: </th>
                                        <td class="value"> <?php echo $data['saldo_cash']; ?></td>
                                    </tr>
