    ...
    <div  class="bg-white p-1 mb-1">
        <div class="container-fluid">
            <div class="row ">
                ...
                <div class="col-sm-3 ">
                    <div class=""><div>
                        <?php if(USER_ROLE==9 or USER_ROLE==20 or USER_ROLE==1){}else{?>
                        <a  class="btn btn btn-primary my-1" href="<?php print_link("data_permintaan_barang/add"); ?>">
            ...
            <div class="row ">
                <div class="col-md-12 comp-grid">
                    ...
                    <div  class=" animated fadeIn page-content">
                        <div id="permintaan_barang-list-records">
