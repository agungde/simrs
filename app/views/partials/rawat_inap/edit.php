                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <select required=""  id="ctrl-dokter_rawat_inap" data-load-path="<?php print_link('api/json/rawat_inap_dokter_rawat_inap_option_list') ?>" name="dokter_rawat_inap"  placeholder="Select a value ..."    class="custom-select" >
                                                    <?php
                                                    $rec = $data['dokter_rawat_inap'];
                                                    $dokter_rawat_inap_options = $comp_model -> rawat_inap_dokter_rawat_inap_option_list($data['poli']);
                                                    if(!empty($dokter_rawat_inap_options)){
                                                    foreach($dokter_rawat_inap_options as $option){
                                                    $value = (!empty($option['value']) ? $option['value'] : null);
                                                    $label = (!empty($option['label']) ? $option['label'] : $value);
                                                    $selected = ( $value == $rec ? 'selected' : null );
                                                    ?>
