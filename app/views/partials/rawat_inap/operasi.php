                ...
                <div class="row ">
                    <div class="col-md-12 comp-grid">
                        ...
                        <div  class=" animated fadeIn page-content">
                            <div id="rawat_inap-operasi-records">
                                    ...
                                    <table class="table  table-sm text-left">
                                        ...
                                        <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                            ...
                                            <tr>
                                                ...
                                                <td class="td-id_poli"> <?php echo $data['id_poli']; ?></td>
                                                ...
                                                <td class="td-dokter_rawat_inap"> <?php echo $data['dokter_rawat_inap']; ?></td>
                                                ...
                                                <td class="page-list-action td-btn">
                                                    <div class="dropdown" >
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            ...
                                                            <?php } ?>
                                                            <?php if($can_edit){ ?>
                                                            <a class="dropdown-item page-modal" href="<?php print_link("rawat_inap/edit/$rec_id"); ?>">
                                                                <i class="fa fa-edit"></i> Edit
                                                            </a>
                                                            <?php } ?>
                                                            <?php if($can_delete){ ?>
                                                            <a  class="dropdown-item record-delete-btn" href="<?php print_link("rawat_inap/delete/$rec_id/?csrf_token=$csrf_token&redirect=$current_page"); ?>" data-prompt-msg="Are you sure you want to delete this record?" data-display-style="modal">
