...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="add"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-white p-1 mb-1">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Chekin Pasien Rawat Inap</h4>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row ">
                <div class="col-md-7 comp-grid">
                    <div class=""> <?php
                        ...
                        $sqlcek3 = mysqli_query($koneksi,"select * from rawat_inap WHERE id='$idpost'");
                        while ($row3=mysqli_fetch_array($sqlcek3)){
                        ...
                        mysqli_query($koneksi,"UPDATE rawat_inap SET setatus='Chekin' WHERE id='$idpost'");
                        ?>
                        <script language="JavaScript">
                            alert('Chekin Pasien Rawat Inap Berhasil!!');
                ...
                <div  class="bg-light p-3 animated fadeIn page-content">
                    <form id="rawat_inap-chekin-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="<?php print_link("rawat_inap/chekin?csrf_token=$csrf_token") ?>" method="post"><input type="hidden" name="precod" value="<?php echo $original_plaintext;?>"/>
                        <div>
