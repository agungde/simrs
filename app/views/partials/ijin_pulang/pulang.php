            ...
            <div class="row ">
                <div class="col ">
                    ...
                    <script>
                        ...
                        if (result == true) {
                        document.getElementById("ijin_pulang-pulang-form").submit();
                        return true;
                        }
                        else {
                        return false;
            ...
            <div class="row ">
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form id="ijin_pulang-pulang-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="<?php print_link("ijin_pulang/pulang?csrf_token=$csrf_token") ?>" method="post">
                            <div>
                                    ...
                                    <input value="<?php echo $id_transaksi;?>" type="hidden"  required="" name="id_transaksi"/>  
                                        <div class="form-group ">
                                            ...
                                            <input id="ctrl-nama_pasien"  value="<?php echo $nama_pasien;?>" type="hidden" placeholder="Enter Nama Pasien"  required="" name="nama_pasien"  class="form-control " />
                                                <input id="ctrl-darecord"  value="<?php echo $darecord;?>" type="hidden" placeholder="Enter Nama Pasien"  required="" name="darecord"  class="form-control " />                 
