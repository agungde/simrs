...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="edit"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Edit  Ijin Pulang</h4>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row ">
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("ijin_pulang/edit/$page_id/?csrf_token=$csrf_token"); ?>" method="post">
                            <div>
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="form-group ">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <select required=""  id="ctrl-poli" data-load-select-options="dokter" name="poli"  placeholder="Select a value ..."    class="custom-select" >
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <select  id="ctrl-dokter" data-load-path="<?php print_link('api/json/ijin_pulang_dokter_option_list') ?>" name="dokter"  placeholder="Select a value ..."    class="custom-select" >
                                                            <?php
                                                            $rec = $data['dokter'];
                                                            $dokter_options = $comp_model -> ijin_pulang_dokter_option_list($data['poli']);
