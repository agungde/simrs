...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="add"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Add New Ranap Bersalin</h4>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row ">
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form id="ranap_bersalin-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="<?php print_link("ranap_bersalin/add?csrf_token=$csrf_token") ?>" method="post">
                            <div>
                                                                                ...
                                                                                <div class="form-group ">
                                                                                    ...
                                                                                    <div class="form-group ">
                                                                                        ...
                                                                                        <div class="form-group ">
                                                                                            <div class="row">
                                                                                                <div class="col-sm-4">
                                                                                                    <label class="control-label" for="dokter_ranap_bersalin">Dokter Ranap Bersalin <span class="text-danger">*</span></label>
                                                                                                </div>
                                                                                                <div class="col-sm-8">
                                                                                                    <div class="">
                                                                                                        <input id="ctrl-dokter_ranap_bersalin"  value="<?php  echo $this->set_field_value('dokter_ranap_bersalin',""); ?>" type="number" placeholder="Enter Dokter Ranap Bersalin" step="1"  required="" name="dokter_ranap_bersalin"  class="form-control " />
                                                                                                        </div>
                                                                                                    </div>
                                                                                                </div>
                                                                                            </div>
                                                                                                                                                                            ...
                                                                                                                                                                            <div class="form-group ">
                                                                                                                                                                                ...
                                                                                                                                                                                <div class="form-group ">
                                                                                                                                                                                    ...
                                                                                                                                                                                    <div class="form-group ">
                                                                                                                                                                                        <div class="row">
                                                                                                                                                                                            <div class="col-sm-4">
                                                                                                                                                                                                <label class="control-label" for="ranap_bersalin">Ranap Bersalin <span class="text-danger">*</span></label>
                                                                                                                                                                                            </div>
                                                                                                                                                                                            <div class="col-sm-8">
                                                                                                                                                                                                <div class="">
                                                                                                                                                                                                    <input id="ctrl-ranap_bersalin"  value="<?php  echo $this->set_field_value('ranap_bersalin',""); ?>" type="text" placeholder="Enter Ranap Bersalin"  required="" name="ranap_bersalin"  class="form-control " />
                                                                                                                                                                                                    </div>
                                                                                                                                                                                                </div>
                                                                                                                                                                                            </div>
                                                                                                                                                                                        </div>
