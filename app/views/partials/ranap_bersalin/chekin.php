            ...
            <div class="row ">
                <div class="col-md-7 comp-grid">
                    <div class=""> <?php
                        ...
                        $sqlcek3 = mysqli_query($koneksi,"select * from ranap_bersalin WHERE id='$idpost'");
                        while ($row3=mysqli_fetch_array($sqlcek3)){
                        ...
                        mysqli_query($koneksi,"UPDATE ranap_bersalin SET setatus='Chekin' WHERE id='$idpost'");
                        ?>
                        <script language="JavaScript">
                            alert('Chekin Pasien RANAP BERSALIN Berhasil!!');
                ...
                <div  class="bg-light p-3 animated fadeIn page-content">
                    <form id="ranap_bersalin-chekin-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="<?php print_link("ranap_bersalin/chekin?csrf_token=$csrf_token") ?>" method="post">
