...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="add"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Add Resep Obat Ranap Bersalin</h4>
                </div>
            </div>
        </div>
    </div>
    ...
    <div  class="">
            ...
            <div class="row ">
                <div class="col-md-9 comp-grid">
                    <div class=""><?php
                        ...
                        $sql = mysqli_query($koneksi,"select * from ranap_bersalin WHERE id='$idpoli'");
                        ...
                        mysqli_query($koneksi,"INSERT INTO `resep_obat` (`pasien`,`pembayaran`,`tebus_resep`,`id_daftar`,`no_rekam_medis`, `tanggal`, `nama_poli`, `nama_pasien`, `alamat`, `tanggal_lahir`, `umur`, `nama_dokter`) VALUES ('RANAP BERSALIN','Luar','Luar','$idpoli','$no_rekam_medis', '$tanggal', '$nama_poli', '$nama_pasien', '$alamat', '$tanggal_lahir', '$umurnya', '$nama_dokter')");  
                        } 
                        ...
                        mysqli_query($koneksi,"INSERT INTO `resep_obat` (`pasien`,`id_daftar`,`no_rekam_medis`, `tanggal`, `nama_poli`, `nama_pasien`, `alamat`, `tanggal_lahir`, `umur`, `nama_dokter`) VALUES ('RANAP BERSALIN','$idpoli','$no_rekam_medis', '$tanggal', '$nama_poli', '$nama_pasien', '$alamat', '$tanggal_lahir', '$umurnya', '$nama_dokter')");    
                        ...
                        */
                        ...
                        <script language="JavaScript">
                            ...
                            document.location='<?php print_link("ranap_bersalin/resep?precord=$precodback&pesanresep=racikan"); ?>';
                            <?php }else{?>
                            document.location='<?php print_link("ranap_bersalin/resep?precord=$precodback&pesanresep=nonracikan"); ?>';
                            <?php }?>
                        </script>
                        <?php
                        }else{
                    ...
                    <tr><td> <?php echo $namobarl;?></td><td>&nbsp;&nbsp; <?php echo $nonjuml;?></td><td>&nbsp;&nbsp; <?php echo $atminuml;?></td><td>
                        <div class="dropdown" >
                            ...
                            <ul class="dropdown-menu">
                                ...
                                ?>
                                <a  class="dropdown-item record-delete-btn" href="<?php print_link("data_resep/resep?precord=$ciphertextdt&pasien=RANAP BERSALIN&action=HAPUS&backlink=$backlink&dari=ranap_bersalin"); ?>" data-prompt-msg="Anda Yakin Mau Hapus Obat <?php echo $namobar;?>?" data-display-style="modal">
        ...
        <form name="proses" id="proses" method="post" action="<?php print_link("data_resep/resep?csrf_token=$csrf_token") ?>">
            <input type="hidden" name="prosesresep" value="<?php echo $original_plaintext;?>"/>
                <input type="hidden" name="dari" value="ranap_bersalin"/>
            </form>                                                   
            <script>
            ...
            <div id="non" class="tabcontent">
                <h3>Non Racikan</h3>
                <form action="<?php  print_link("ranap_bersalin/resep?csrf_token=$csrf_token");?>" method="POST">
