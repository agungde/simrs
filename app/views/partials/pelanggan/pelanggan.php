            ...
            <div class="row ">
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form id="pelanggan-pelanggan-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="<?php print_link("pelanggan/pelanggan?csrf_token=$csrf_token") ?>" method="post">
                            <div>
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <select required="" data-endpoint="<?php print_link('api/json/pelanggan_nama_pelanggan_option_list') ?>" id="ctrl-nama_pelanggan" name="nama_pelanggan"  placeholder="Select a value ..."    class="selectize-ajax" >
