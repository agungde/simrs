...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="add"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Chekin  Ranap Anak</h4>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row ">
                <div class="col-md-7 comp-grid">
                    <div class=""> <?php
                        ...
                        $sqlcek3 = mysqli_query($koneksi,"select * from ranap_anak WHERE id='$idpost'");
                        while ($row3=mysqli_fetch_array($sqlcek3)){
                        ...
                        mysqli_query($koneksi,"UPDATE ranap_anak SET setatus='Chekin' WHERE id='$idpost'");
                        ?>
                        <script language="JavaScript">
                            alert('Chekin Pasien RANAP ANAK Berhasil!!');
                ...
                <div  class="bg-light p-3 animated fadeIn page-content">
                    <form id="ranap_anak-chekin-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="<?php print_link("ranap_anak/chekin?csrf_token=$csrf_token") ?>" method="post">
