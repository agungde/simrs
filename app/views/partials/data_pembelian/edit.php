...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="edit"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-white p-1 mb-1">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Edit  Data Pembelian</h4>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row ">
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("data_pembelian/edit/$page_id/?csrf_token=$csrf_token"); ?>" method="post">
                            <div>
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-id_data_pembelian"  value="<?php  echo $data['id_data_pembelian']; ?>" type="number" placeholder="Enter Id Data Pembelian" step="1"  required="" name="id_data_pembelian"  class="form-control " />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                                                ...
                                                                                <div class="form-group ">
                                                                                    ...
                                                                                    <div class="form-group ">
                                                                                        <div class="row">
                                                                                            ...
                                                                                            <div class="col-sm-8">
                                                                                                <div class="">
                                                                                                    <input id="ctrl-type_pembelian"  value="<?php  echo $data['type_pembelian']; ?>" type="text" placeholder="Enter Type Pembelian"  required="" name="type_pembelian"  class="form-control " />
                                                                                                    </div>
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                                            ...
                                                                                            <div class="form-group ">
                                                                                                ...
                                                                                                <div class="form-group ">
                                                                                                    <div class="row">
                                                                                                        ...
                                                                                                        <div class="col-sm-8">
                                                                                                            <div class="">
                                                                                                                <input id="ctrl-idtrace"  value="<?php  echo $data['idtrace']; ?>" type="text" placeholder="Enter Idtrace"  required="" name="idtrace"  class="form-control " />
                                                                                                                </div>
                                                                                                            </div>
                                                                                                        </div>
                                                                                                    </div>
                                                                                                        ...
                                                                                                        <div class="form-group ">
                                                                                                            ...
                                                                                                            <div class="form-group ">
                                                                                                                <div class="row">
                                                                                                                    ...
                                                                                                                    <div class="col-sm-8">
                                                                                                                        <div class="">
                                                                                                                            <input id="ctrl-total_diskon"  value="<?php  echo $data['total_diskon']; ?>" type="number" placeholder="Enter Total Diskon" step="1"  required="" name="total_diskon"  class="form-control " />
                                                                                                                            </div>
                                                                                                                        </div>
                                                                                                                    </div>
                                                                                                                </div>
