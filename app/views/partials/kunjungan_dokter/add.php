...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="add"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Add New Kunjungan Dokter</h4>
                    <div class=""><div>
                        <?php
                        $usrnam  = "".USER_NAME;
                        $id_user = "".USER_ID;
            ...
            <div class="row ">
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form id="kunjungan_dokter-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="<?php print_link("kunjungan_dokter/add?csrf_token=$csrf_token") ?>" method="post">
                            <div>
                                <input id="ctrl-id_daftar"  value="<?php echo $original_plaintext;?>" type="hidden" placeholder="Enter Id Daftar"  required="" name="id_daftar"  class="form-control " />
                                    <input value="<?php echo $darecord;?>" type="hidden" required="" name="darecord"  class="form-control " />       
                                        <input value="<?php echo $id_transaksi;?>" type="hidden"  required="" name="id_transaksi"/> 
                                            <div class="form-group ">
                                                ...
                                                <input id="ctrl-no_rekam_medis"  value="<?php echo $no_rekam_medis;?>" type="hidden" placeholder="Enter No Rekam Medis"  required="" name="no_rekam_medis"  class="form-control " />
                                                    <input id="ctrl-idback"  value="<?php echo $idback;?>" type="hidden"  required="" name="idback"  class="form-control " />                             
                                                        <div class="form-group ">
                                                            <div class="row">
                                                                <div class="col-sm-4">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <div class="">
                                                                        <select required=""  id="ctrl-dokter" name="dokter"  placeholder="Select a value ..."    class="custom-select" >
                                                                            ...
                                                                            <?php 
                                                                            $dokter_options = $comp_model -> kunjungan_dokter_dokter_option_list();
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <div class="">
                                                                        ...
                                                                        if($ttddok==""){?>
                                                                        <a class="btn btn-sm btn-primary has-tooltip page-modal" href="<?php  print_link("ttd/add?precord=$no_rekam_medis&datdari=kunjungan_dokter&ttd=Dokter&datprecord=$datprecord&darecord=$darecord");?>"> Buat TTD Digital</a>   
