...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="view"  data-display-type="table" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-white p-1 mb-1">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Detile  Rekam Medis</h4>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row ">
                <div class="col-md-12 comp-grid">
                    ...
                    <div class=" ">
                        <?php  
                        $this->render_page("data_rekam_medis/detile/data_rekam_medis.no_rekam_medis/$data[no_rekam_medis]?orderby=data_rekam_medis.id&ordertype=DESC&limit_count=20"); 
                        ?>
                    </div>
                </div>
            </div>
