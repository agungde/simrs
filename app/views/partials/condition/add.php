                            ...
                            <div>
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-id_condition"  value="<?php  echo $this->set_field_value('id_condition',""); ?>" type="text" placeholder="Enter Id Condition"  required="" name="id_condition"  class="form-control " />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        ...
                                        <div class="form-group ">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <input id="ctrl-ihs_pasien"  value="<?php  echo $this->set_field_value('ihs_pasien',""); ?>" type="number" placeholder="Enter Ihs Pasien" step="1"  required="" name="ihs_pasien"  class="form-control " />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
