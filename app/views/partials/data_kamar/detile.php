...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="add"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-white p-1 mb-1">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">View Detil Kamar</h4>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row ">
                <div class="col-md-12 comp-grid">
                    <div class=""><?php
                        ...
                        $queryb = mysqli_query($koneksi, "select * from data_kamar WHERE id_data_kamar='$fromdata'")
                        ...
                        if(isset($_POST[$post])){
                        if($_POST[$post]==""){}else{
                        mysqli_query($koneksi,"UPDATE data_ranjang SET no_$nom='isi' WHERE id_data_kamar='$fromdata'");
                        mysqli_query($koneksi,"UPDATE rawat_inap SET no_ranjang='No $nom' WHERE id='$original_plaintext'");
                        }
                        }
                        }
                        // mysqli_query($koneksi,"INSERT INTO `data_ranjang` (`jumlah_ranjang`,`id_data_kamar`) VALUES ('$jumlah_ranjang','$rec_id')"); 
                        mysqli_query($koneksi,"UPDATE rawat_inap SET kamar_kelas='".$data['kamar_kelas']."', nama_kamar='".$data['nama_kamar']."', no_kamar='".$data['no_kamar']."' WHERE id='$original_plaintext'");
                        $terisiplus=$terisi + 1;
                        $siasa=$jumranjang - $terisiplus;
                        mysqli_query($koneksi,"UPDATE data_kamar SET sisa='$siasa', terisi='$terisiplus' WHERE id_data_kamar='$fromdata'");
                        ?>
                    ...
                    <div  class="card animated fadeIn page-content">
                        ...
                        <form id="data_kamar-detile-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="<?php print_link("data_kamar/detile?csrf_token=$csrf_token") ?>" method="post">
                            <div>
                                <?php
                                $usrnam  = "".USER_NAME;
                                $id_user = "".USER_ID;
