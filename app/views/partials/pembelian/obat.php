    ...
    <div  class="bg-white p-1 mb-1">
        <div class="container-fluid">
            <div class="row ">
                ...
                </div><h4 class="record-title">Pembelian Obat</h4>
            </div>
            <div class="col-sm-3 ">
                <?php if($can_add){ ?>
                <a  class="btn btn btn-primary my-1" href="<?php print_link("transaksi_pembelian/pembelian?category=OBAT") ?>">
