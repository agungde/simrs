...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="edit"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-white p-1 mb-1">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Edit  Permintaan Harga</h4>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row ">
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("permintaan_harga/edit/$page_id/?csrf_token=$csrf_token"); ?>" method="post">
                            <div>
                                <div class="form-group ">
                                    ...
                                    <input id="ctrl-category_barang"  value="<?php  echo $data['category_barang']; ?>" type="hidden" placeholder="Enter Category Barang" list="category_barang_list"  required="" name="category_barang"  class="form-control " />
                                        ...
                                        <input id="ctrl-no_request"  value="<?php  echo $data['no_request']; ?>" type="hidden" placeholder="Enter No Request"  required="" name="no_request"  class="form-control " />
                                        </div>
