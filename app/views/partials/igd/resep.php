...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="add"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-white p-1 mb-1">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Add Resep Obat Pasien IGD</h4>
                </div>
            </div>
        </div>
    </div>
    ...
    <div  class="">
        <div class="container">
            <div class="row ">
                <div class="col-md-10 comp-grid">
                    <div class=""><?php
                        ...
                        $sql = mysqli_query($koneksi,"select * from igd WHERE id_igd='$idpoli'");
                        ...
                        */
                        ...
                        $queryrc = mysqli_query($koneksi, "SELECT max(racikan) as nomor from data_resep WHERE id_daftar='$idpoli' and no_rekam_medis='$no_rekam_medis'")
                        or die('Ada kesalahan pada query tampil data : ' . mysqli_error($koneksi));
                        ...
                        mysqli_query($koneksi,"INSERT INTO `resep_obat` (`pasien`,`pembayaran`,`tebus_resep`,`id_daftar`,`no_rekam_medis`, `tanggal`, `nama_poli`, `nama_pasien`, `alamat`, `tanggal_lahir`, `umur`, `nama_dokter`) VALUES ('IGD','Luar','Luar','$idpoli','$no_rekam_medis', '$tanggal', '$nama_poli', '$nama_pasien', '$alamat', '$tanggal_lahir', '$umurnya', '$nama_dokter')");  
                        } 
                        ...
                        mysqli_query($koneksi,"INSERT INTO `resep_obat` (`pasien`,`id_daftar`,`no_rekam_medis`, `tanggal`, `nama_poli`, `nama_pasien`, `alamat`, `tanggal_lahir`, `umur`, `nama_dokter`) VALUES ('IGD','$idpoli','$no_rekam_medis', '$tanggal', '$nama_poli', '$nama_pasien', '$alamat', '$tanggal_lahir', '$umurnya', '$nama_dokter')");    
                        ...
                        */
                        ...
                        <script language="JavaScript">
                            ...
                            document.location='<?php print_link("igd/resep?precord=$precodback&pesanresep=racikan"); ?>';
                            <?php }else{?>
                            document.location='<?php print_link("igd/resep?precord=$precodback&pesanresep=nonracikan"); ?>';
                            <?php }?>
                        </script>
                        <?php
                        }else{
                        ...
                        <?php
                        $Querydo = "SELECT * FROM data_resep where id_daftar='$original_plaintext'";
                        $ExecQuerydo = MySQLi_query($koneksi, $Querydo);
                        $rowsdo = mysqli_num_rows($ExecQuerydo);
                        if ($rowsdo <> 0) {
                        $datr= mysqli_fetch_assoc($ExecQuerydo);
                        ...
                        ?>
                        <a style="margin-top:1px;" class="btn btn-sm btn-primary has-tooltip page-modal" href="<?php  print_link("data_resep/proses?csrf_token=$csrf_token&precord=$ciphertext&view=$ciphertext");?>">
                        <i class="fa fa-eye"></i> Lihat Resep Yg Sudah Di Simpan</a> 
                        <?php }
                        }
                        ?>
                    </div></div>
                    ...
                    <tr><td> <?php echo $namobarl;?></td><td>&nbsp;&nbsp; <?php echo $nonjuml;?></td><td>&nbsp;&nbsp; <?php echo $atminuml;?></td><td>
                        <div class="dropdown" >
                            ...
                            <ul class="dropdown-menu">
                                ...
                                ?>
                                <a  class="dropdown-item record-delete-btn" href="<?php print_link("data_resep/resep?precord=$ciphertextdt&pasien=IGD&action=HAPUS&backlink=$backlink&dari=igd"); ?>" data-prompt-msg="Anda Yakin Mau Hapus Obat <?php echo $namobar;?>?" data-display-style="modal">
            ...
            $Quer = "SELECT * FROM data_resep where id_daftar='$original_plaintext' and racikan='$x' and resep='0'";
        ...
        <form name="proses" id="proses" method="post" action="<?php print_link("data_resep/resep?csrf_token=$csrf_token") ?>">
            <input type="hidden" name="prosesresep" value="<?php echo $original_plaintext;?>"/>
                <input type="hidden" name="dari" value="igd"/>
            </form>                                                   
            <script>
            ...
            <div id="non" class="tabcontent">
                <h3>Non Racikan</h3>
                <form action="<?php  print_link("igd/resep?csrf_token=$csrf_token");?>" method="POST">
                                ...
                                <input type="hidden" name="precod" value="<?php echo $original_plaintext;?>">
                                    <input type="hidden" name="precodback" value="<?php echo $backlink;?>">
                                        ...
                                        <script type="text/javascript">
                                            ...
                                            <?php 
                                            $linksite="".SITE_ADDR;
                                            $jsonnon="api/json/data_resep_nama_obat_option_list";
                                            $datajson="$linksite$jsonnon";
                                            ?>
                                                            ...
                                                            <form action="<?php  print_link("igd/resep?csrf_token=$csrf_token");?>" method="POST">
                                                                <div class="form-group ">
                                                                    ...
                                                                    <input type="hidden" name="addresep" value="alkes">
                                                                        ...
                                                                        <div class=""><div>
                                                                            <?php if(USER_ROLE==3){?>
                                                                            <iframe src="<?php print_link("datarekam.php?csrf_token=$csrf_token&precord=$backlink&pasien=IGD") ?>" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                                                                            <?php }?>     
                                                                        </div>
                                                                    </div>
                                                                </div>
