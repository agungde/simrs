...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="add"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Add New Data Rekam Medis</h4>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row ">
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form id="data_rekam_medis-catatan_medis-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="<?php print_link("data_rekam_medis/catatan_medis?csrf_token=$csrf_token") ?>" method="post">
                            <div>
                                                        ...
                                                        <div class="form-group ">
                                                            ...
                                                            <div class="form-group ">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-8">
                                                                        <div class="">
                                                                            <input id="ctrl-suhu_badan"  value="<?php  echo $this->set_field_value('suhu_badan',""); ?>" type="text" placeholder="Enter Suhu Badan"  required="" name="suhu_badan"  class="form-control " />
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group ">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-sm-8">
                                                                            <div class="">
                                                                                <textarea placeholder="Enter Resep Obat" id="ctrl-resep_obat"  required="" rows="5" name="resep_obat" class=" form-control"><?php  echo $this->set_field_value('resep_obat',""); ?></textarea>
                                                                ...
                                                                <div class="form-group ">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-sm-8">
                                                                            <div class="">
                                                                                <input id="ctrl-persetujuan_tindakan"  value="<?php  echo $this->set_field_value('persetujuan_tindakan',""); ?>" type="text" placeholder="Enter Persetujuan Tindakan"  required="" name="persetujuan_tindakan"  class="form-control " />
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                            ...
                                                                            <div class="form-group ">
                                                                                ...
                                                                                <div class="form-group ">
                                                                                    ...
                                                                                    <div class="form-group ">
                                                                                        <div class="row">
                                                                                            <div class="col-sm-4">
                                                                                                <label class="control-label" for="alergi_obat">Alergi Obat <span class="text-danger">*</span></label>
                                                                                            </div>
                                                                                            <div class="col-sm-8">
                                                                                                <div class="">
                                                                                                    <input id="ctrl-alergi_obat"  value="<?php  echo $this->set_field_value('alergi_obat',""); ?>" type="text" placeholder="Enter Alergi Obat"  required="" name="alergi_obat"  class="form-control " />
                                                                                                    </div>
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
