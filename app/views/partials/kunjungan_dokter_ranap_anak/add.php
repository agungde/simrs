        ...
        <div class="container">
            <div class="row ">
                ...
                <div  class="bg-light p-3 animated fadeIn page-content">
                    <form id="kunjungan_doktek_ranap_anak-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="<?php print_link("kunjungan_doktek_ranap_anak/add?csrf_token=$csrf_token") ?>" method="post">
                        <div>
