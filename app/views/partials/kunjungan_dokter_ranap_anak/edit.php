...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="edit"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Edit  Kunjungan Dokter</h4>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row ">
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("kunjungan_doktek_ranap_anak/edit/$page_id/?csrf_token=$csrf_token"); ?>" method="post">
                            <div>
                                <input id="ctrl-id_daftar"  value="<?php  echo $data['id_daftar']; ?>" type="hidden" placeholder="Enter Id Daftar"  required="" name="id_daftar"  class="form-control " />
                                    <div class="form-group ">
                                        ...
                                        <input id="ctrl-no_rekam_medis"  value="<?php  echo $data['no_rekam_medis']; ?>" type="hidden" placeholder="Enter No Rekam Medis"  required="" name="no_rekam_medis"  class="form-control " />
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            <select required=""  id="ctrl-dokter" name="dokter"  placeholder="Select a value ..."    class="custom-select" >
                                                                ...
                                                                <?php
                                                                $rec = $data['dokter'];
                                                                $dokter_options = $comp_model -> kunjungan_doktek_ranap_anak_dokter_option_list();
                                            ...
                                            <input id="ctrl-id_transaksi"  value="<?php  echo $data['id_transaksi']; ?>" type="hidden" placeholder="Enter Id Transaksi"  required="" name="id_transaksi"  class="form-control " />
                                            </div>
