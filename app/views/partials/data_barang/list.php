    ...
    <div  class="bg-white p-1 mb-1">
        <div class="container-fluid">
            <div class="row ">
                ...
                <div class="col-sm-3 ">
                    <?php if($can_add){ ?>
                    <a  class="btn btn btn-primary my-1" href="<?php print_link("data_barang/add") ?>">
                ...
                <div class="col-sm-4 ">
                    <form  class="search" action="<?php print_link('data_barang'); ?>" method="get">
                            ...
                            <nav class="page-header-breadcrumbs mt-2" aria-label="breadcrumb">
                                <ul class="breadcrumb m-0 p-1">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a class="text-decoration-none" href="<?php print_link('data_barang'); ?>">
                ...
                <div class="row ">
                    <div class="col-sm-7 comp-grid">
                        <div class=""><div><?php
                            ...
                            $query       = mysqli_query($koneksi, "SELECT * from data_barang_temp where idtrace='$idtrace'") or die('Ada kesalahan pada query tampil data : ' . mysqli_error($koneksi));
                            $rows = mysqli_num_rows($query);
                            if ($rows <> 0) {
                            ?>
                            <a class="btn btn-sm btn-primary has-tooltip"  href="<?php print_link("data_barang_temp"); ?>">                       
                                <i class="fa fa-plus "></i>
                                Lihat Impor Data
                            </a> 
                            <?php
                        ...
                        <div class="container-fluid">
                            <div class="row ">
                                ...
                                <div class="card mb-3 sticky-top">
                                    ...
                                    <div class="collapse collapse-lg " id="<?php echo $menu_id ?>">
                                        <ul class="nav nav-pills">
                                            <?php 
                                            $option_list = $comp_model->data_barang_data_barangcategory_barang_option_list();
                                            if(!empty($option_list)){
                                            foreach($option_list as $option){
                                            $value = (!empty($option['value']) ? $option['value'] : null);
                                            $label = (!empty($option['label']) ? $option['label'] : $value);
                                            $nav_link = $this->set_current_page_link(array('data_barang_category_barang' => $value , 'data_barang_category_baranglabel' => $label) , false);
                                            ?>
                                            <li class="nav-item">
                                                <a class="nav-link <?php echo is_active_link('data_barang_category_barang', $value); ?>" href="<?php print_link($nav_link) ?>">
                                                    <?php echo $label; ?>
                                                </a>
                                            </li>
                                            <?php
                                ...
                                <div class="filter-tags mb-2">
                                    <?php
                                    if(!empty(get_value('data_barang_category_barang'))){
                                    ?>
                                    <div class="filter-chip card bg-light">
                                        <b>Category Barang :</b> 
                                        <?php 
                                        if(get_value('data_barang_category_baranglabel')){
                                        echo get_value('data_barang_category_baranglabel');
                                        }
                                        else{
                                        echo get_value('data_barang_category_barang');
                                        }
                                        $remove_link = unset_get_value('data_barang_category_barang', $this->route->page_url);
                                        ?>
                                ...
                                <div  class=" animated fadeIn page-content">
                                    <div id="data_barang-list-records">
                                            ...
                                            <table class="table  table-sm text-left">
                                                <thead class="table-header bg-success text-dark">
                                                    <tr>
                                                        ...
                                                        <th  class="td-warning_setok"> Warning Setok</th>
                                                ...
                                                <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="td-warning_setok"> <?php echo $data['warning_setok']; ?></td>
                                                        <td class="td-action"> <span>
                                                            ...
                                                            $koneksi = new mysqli($dbhost, $dbuser,$dbpass, $dbname);
                                                            $idtrace = "$id_user$usrnam";
                                                            $query = mysqli_query($koneksi, "SELECT * from setok_barang where id_data='$rec_id'") or die('Ada kesalahan pada query tampil data : ' . mysqli_error($koneksi));
                                                            // ambil jumlah baris data hasil query
                                                            $rows = mysqli_num_rows($query);
                                                            if ($rows <> 0) {// ambil data hasil query
                                                            $datab = mysqli_fetch_assoc($query);
                                                            $harga_jual  = $datab['harga_jual'];
                                                            $harga_beli  = $datab['harga_beli'];
                                                            $id_barang  = $datab['id_barang'];
                                                            }
                                                            if($harga_jual=="" or $harga_jual=="0"){
                                                            ?>
                                                            <a class="btn btn-sm btn-info has-tooltip page-modal" title="Edit This Record" href="<?php print_link("setok_barang/edit/$id_barang&redirect=$current_page"); ?>">
                                                            <i class="fa fa-edit"></i> Isi Harga</a>  
                                                            <?php
                                                            }else{
                                                            $beli=number_format($harga_beli,0,",",".");
                                                            $jual=number_format($harga_jual,0,",",".");
                                                            echo"<div>Beli $beli</div>";
                                                            echo"<div>Jual $jual</div>";
                                                            ?>
                                                            <a class="btn btn-sm btn-info has-tooltip page-modal" title="Edit This Record" href="<?php print_link("setok_barang/edit/$id_barang&redirect=$current_page"); ?>">
                                                            <i class="fa fa-edit"></i> Edite Harga</a>  
                                                            <?php    
                                                            }
                                                            ?>
                                                        </span></td>
                                                        ...
                                                        <td class="page-list-action td-btn">
                                                            <div class="dropdown" >
                                                                ...
                                                                <ul class="dropdown-menu">
                                                                    <?php if($can_view){ ?>
                                                                    <a class="dropdown-item page-modal" href="<?php print_link("data_barang/view/$rec_id"); ?>">
                                                                        <i class="fa fa-eye"></i> View 
                                                                    </a>
                                                                    <?php } ?>
                                                                    <?php if($can_edit){ ?>
                                                                    <a class="dropdown-item page-modal" href="<?php print_link("data_barang/edit/$rec_id"); ?>">
