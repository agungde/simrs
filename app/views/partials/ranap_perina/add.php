            ...
            <div class="row ">
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form id="ranap_perina-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="<?php print_link("ranap_perina/add?csrf_token=$csrf_token") ?>" method="post">
                            <div>
                                                                                            ...
                                                                                            <div class="form-group ">
                                                                                                ...
                                                                                                <div class="form-group ">
                                                                                                    <div class="row">
                                                                                                        ...
                                                                                                        <div class="col-sm-8">
                                                                                                            <div class="">
                                                                                                                <input id="ctrl-dokter_ranap_perina"  value="<?php  echo $this->set_field_value('dokter_ranap_perina',""); ?>" type="number" placeholder="Enter Dokter Ranap Perina" step="1"  required="" name="dokter_ranap_perina"  class="form-control " />
                                                                                                                </div>
                                                                                                            </div>
                                                                                                        </div>
                                                                                                    </div>
                                                                                                                                                                                        ...
                                                                                                                                                                                        <div class="form-group ">
                                                                                                                                                                                            ...
                                                                                                                                                                                            <div class="form-group ">
                                                                                                                                                                                                <div class="row">
                                                                                                                                                                                                    ...
                                                                                                                                                                                                    <div class="col-sm-8">
                                                                                                                                                                                                        <div class="">
                                                                                                                                                                                                            <input id="ctrl-ranap_perina"  value="<?php  echo $this->set_field_value('ranap_perina',""); ?>" type="text" placeholder="Enter Ranap Perina"  required="" name="ranap_perina"  class="form-control " />
                                                                                                                                                                                                            </div>
                                                                                                                                                                                                        </div>
                                                                                                                                                                                                    </div>
                                                                                                                                                                                                </div>
