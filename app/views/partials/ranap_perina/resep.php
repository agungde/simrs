...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="add"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Add Resep Obat Ranap Perina</h4>
                    <div class=""><?php
                        $usrnam  = "".USER_NAME;
                        $id_user = "".USER_ID;
                        $dbhost  = "".DB_HOST;
                        ...
                        $sql = mysqli_query($koneksi,"select * from ranap_perina WHERE id='$idpoli'");
                        ...
                        mysqli_query($koneksi,"INSERT INTO `resep_obat` (`pasien`,`pembayaran`,`tebus_resep`,`id_daftar`,`no_rekam_medis`, `tanggal`, `nama_poli`, `nama_pasien`, `alamat`, `tanggal_lahir`, `umur`, `nama_dokter`) VALUES ('RANAP PERINA','Luar','Luar','$idpoli','$no_rekam_medis', '$tanggal', '$nama_poli', '$nama_pasien', '$alamat', '$tanggal_lahir', '$umurnya', '$nama_dokter')");  
                        } 
                        $query2 = mysqli_query($koneksi, "select * from resep_obat WHERE tebus_resep='Luar' and no_rekam_medis='$no_rekam_medis' and id_daftar='$idpoli' and resep='0'")  or die('Ada kesalahan pada query tampil data : ' . mysqli_error($koneksi));
                        ...
                        $divisif = "FARMASI";
                        $bagf    = "FARMASI";  
                        $qudat = mysqli_query($koneksi, "SELECT * from data_setok WHERE kode_barang='$kode_obat' and divisi='$divisif' and bagian='$bagf' and jumlah >0")
                        or die('Ada kesalahan pada query tampil data : ' . mysqli_error($koneksi));
                        $rodtpab = mysqli_num_rows($qudat);
                        if ($rodtpab <> 0) {
                        $cdt= mysqli_fetch_assoc($qudat);
                        $jumdatsetokf=$cdt['jumlah'];
                        $iddsetok=$cdt['id'];
                        }else{
                        $jumdatsetokf="";     
                        }
                        if($jumdatsetok==""){
                        if($jumdatsetokf > $qtys or $jumdatsetokf == $qtys ){
                        $stoks=$jumdatsetokf - $qtys;
                        mysqli_query($koneksi,"UPDATE data_setok SET jumlah='$stoks' WHERE kode_barang='$kode_obat' and divisi='$divisif' and bagian='$bagf'"); 
                        $ket_setok="FARMASI";
                        $bag    = "FARMASI"; 
                        }else{
                        ...
                        mysqli_query($koneksi,"INSERT INTO `resep_obat` (`pasien`,`id_daftar`,`no_rekam_medis`, `tanggal`, `nama_poli`, `nama_pasien`, `alamat`, `tanggal_lahir`, `umur`, `nama_dokter`) VALUES ('RANAP PERINA','$idpoli','$no_rekam_medis', '$tanggal', '$nama_poli', '$nama_pasien', '$alamat', '$tanggal_lahir', '$umurnya', '$nama_dokter')");    
                        $queryr = mysqli_query($koneksi, "select * from resep_obat WHERE id_daftar='$idpoli' ORDER BY `id_resep_obat` DESC")
                        or die('Ada kesalahan pada query tampil data : ' . mysqli_error($koneksi));
                        ...
                        */
                        ...
                        <script language="JavaScript">
                            ...
                            document.location='<?php print_link("ranap_perina/resep?precord=$precodback&pesanresep=racikan"); ?>';
                            <?php }else{?>
                            document.location='<?php print_link("ranap_perina/resep?precord=$precodback&pesanresep=nonracikan"); ?>';
                            <?php }?>
                        </script>
                        <?php
                        }else{
                        ...
                        <div id="page-report-body" class="table-responsive">
                            <table width="100%">
                                ...
                                <tr>
                                    ...
                                    <td align="left">&nbsp;&nbsp;  <span>TGL-Lahir:</span></td>
                                    <td >
    ...
    <div  class="">
                    ...
                    <tr><td> <?php echo $namobarl;?></td><td>&nbsp;&nbsp; <?php echo $nonjuml;?></td><td>&nbsp;&nbsp; <?php echo $atminuml;?></td><td>
                        <div class="dropdown" >
                            ...
                            <ul class="dropdown-menu">
                                ...
                                ?>
                                <a  class="dropdown-item record-delete-btn" href="<?php print_link("data_resep/resep?precord=$ciphertextdt&pasien=RANAP PERINA&action=HAPUS&backlink=$backlink&dari=ranap_perina"); ?>" data-prompt-msg="Anda Yakin Mau Hapus Obat <?php echo $namobar;?>?" data-display-style="modal">
        ...
        <form name="proses" id="proses" method="post" action="<?php print_link("data_resep/resep?csrf_token=$csrf_token") ?>">
            <input type="hidden" name="prosesresep" value="<?php echo $original_plaintext;?>"/>
                <input type="hidden" name="dari" value="ranap_perina"/>
            </form>                                                   
            <script>
            ...
            <div class="tab">
                ...
                <button class="tablinks" onclick="openResep(event, 'makan')" id="makanan"> Resep MAKANAN</button>
            </div>
            <div id="non" class="tabcontent">
                <h3>Non Racikan</h3>
                <form action="<?php  print_link("ranap_perina/resep?csrf_token=$csrf_token");?>" method="POST">
                                                        ...
                                                        <input type="hidden" name="precodback" value="<?php echo $backlink;?>">
                                                            ...
                                                            echo "  <input type=\"hidden\" name=\"datrem\" value=\"$datrem\">";
                                                                ...
                                                                <table id="dynamicTableAlkes" class="table-striped table-sm text-left">  
                                                                    <tr>
                                                                        <th style="background-color: #228b22; color:#fff;">Nama Alkes</th>
                                                                        <th width="4%" style="background-color: #228b22; color:#fff;">Jumlah</th>
                                                                        <th style="background-color: #228b22; color:#fff;">Action</th>
                                                                    </tr>
                                                                    <tr>  
                                                            ...
                                                            <script type="text/javascript">
                                                                ...
                                                                $("#dynamicTableAlkes").append('<tr><td><?php
                                                                    echo "<select name=\"name[]\" class=\"form-control\" required=\"\">";
                                                                        echo "<option value=\"\">Pilih Nama Obat</option>";
                                                                        $sql11 = mysqli_query($koneksi,"select * from setok_barang where category_barang='2'");
                                                                        while ($row11=mysqli_fetch_array($sql11)){
                                                                        $id_obat11=$row11['id_barang'];
                                                                        $nama_obat11=$row11['nama_barang'];
                                                                        $satuan11=$row11['satuan'];
                                                        ...
                                                        <div id="makan" class="tabcontent">
                                                            ...
                                                            <form action="<?php  print_link("ranap_perina/resep?csrf_token=$csrf_token");?>" method="POST">
                                                                <div class="form-group ">
                                                                    ...
                                                                    <table  id="dynamicTablemakan" class="table-striped table-sm text-left">  
                                                                        <input type="hidden" name="addresep" value="makanan"/>
                                                                        <input type="hidden" name="keterangan" value=""/>
                                                                        ...
                                                                        <input type="hidden" name="precod" value="<?php echo $original_plaintext;?>"/>
                                                                            <input type="hidden" name="precodback" value="<?php echo $backlink;?>"/>
                                                                                ...
                                                                                ?>
                                                                                <tr>
                                                                                    <th style="background-color: #228b22; color:#fff;">Nama</th>
                                                                                    <th width="4%" style="background-color: #228b22; color:#fff;">Jumlah</th>
                                                                                    <th style="background-color: #228b22; color:#fff;">Aturan Pakai</th>
                                                                                    <th style="background-color: #228b22; color:#fff;">Action</th>
                                                                                </tr>
                                                                                <tr>  
                                                                                    <td>
                                                                                        ...
                                                                                        echo "<select name=\"name[]\" class=\"form-control\" required=\"\">";
                                                                                            echo "<option value=\"\">Pilih Nama Obat</option>";
                                                                                            $sql11 = mysqli_query($koneksi,"select * from setok_barang where category_barang='4'");
                                                                                            while ($row11=mysqli_fetch_array($sql11)){
                                                                                            $id_obat11=$row11['id_barang'];
                                                                                            $nama_obat11=$row11['nama_barang'];
                                                                                            $satuan11=$row11['satuan'];
                                                                                    ...
                                                                                    <td><button type="button" name="addm" id="addm" class="btn btn-success"><i class="fa fa-plus"></i></button></td>
                                                                                </tr> 
                                                                            </table> 
                                                                            <div class="form-group form-submit-btn-holder text-center mt-3">
                                                                                <div class="form-ajax-status"></div>
                                                                        ...
                                                                        <script type="text/javascript">
                                                                            ...
                                                                            $("#addm").click(function(){
                                                                            ++i;
                                                                            $("#dynamicTablemakan").append('<tr><td><?php
                                                                                echo "<select name=\"name[]\" class=\"form-control\" required=\"\">";
                                                                                    ...
                                                                                    //echo " <option value=\"airport2\">Airport2</option>";
                                                                                echo " </select>";
                                                                                ?></td><td><input type="text" required=\"\" name="qty[]" placeholder="QTY" class="form-control" /></td><td><table><tr><td width="18%"><input type="text" name="aturan[]" placeholder=".." class="form-control"  /></td><td><button type="button" class="btn btn-danger remove-tr"><i class=\"fa fa-close \"></i></button></td></tr>');
                                                                                });
                                                                                $(document).on('click', '.remove-tr', function(){  
                                                                                $(this).parents('tr').remove();
                                                                                });  
