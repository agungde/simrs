        ...
        <div class="container-fluid">
            <div class="row ">
                <div class="col comp-grid">
                    <h4 >Templete import Data Barang</h4>
                </div>
                <div class="col-sm-3 comp-grid">
                    <a  class="btn btn-primary" href="<?php print_link("templete_import_data_barang/add") ?>">
            ...
            <div class="row ">
                <div class="col-md-12 comp-grid">
                    ...
                    <div  class=" animated fadeIn page-content">
                        <div id="templete_import_data_barang-list-records">
