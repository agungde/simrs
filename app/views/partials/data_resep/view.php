                        ...
                        <div id="page-report-body" class="">
                            ...
                            <table class="table table-hover table-borderless table-striped">
                                ...
                                <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                    <tr  class="td-id_data_resep">
                                        <th class="title"> Id Data Resep: </th>
                                        <td class="value"> <?php echo $data['id_data_resep']; ?></td>
                                    </tr>
                                    <tr  class="td-id_obat">
                                    ...
                                    <tr  class="td-aturan_minum">
                                        ...
                                        <td class="value"> <?php echo $data['aturan_minum']; ?></td>
                                    </tr>
                                    <tr  class="td-jumlah">
                                    ...
                                    <tr  class="td-racikan">
                                        <th class="title"> Racikan: </th>
                                        <td class="value"> <?php echo $data['racikan']; ?></td>
                                    </tr>
                                    ...
                                    <tr  class="td-resep">
                                        <th class="title"> Resep: </th>
                                        <td class="value"> <?php echo $data['resep']; ?></td>
                                    </tr>
                                </tbody>
                                <!-- Table Body End -->
                            </table>
