                                                        ...
                                                        <div class="form-group ">
                                                            ...
                                                            <div class="form-group ">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-8">
                                                                        <div class="">
                                                                            <select required="" data-endpoint="<?php print_link('api/json/data_resep_nama_obat_option_list') ?>" id="ctrl-nama_obat" name="nama_obat"  placeholder="Select a value ..."    class="selectize-ajax" >
                                                                                <option value="">Select a value ...</option>
                                                                            </select>
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <div class="form-group ">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-8">
                                                                        <div class="">
                                                                            <select required=""  id="ctrl-aturan_minum" name="aturan_minum"  placeholder="Select a value ..."    class="custom-select" >
                                                                                <option value="">Select a value ...</option>
                                                                                <?php 
                                                                ...
                                                                <div class="form-group ">
                                                                    ...
                                                                    <div class="form-group ">
                                                                        ...
                                                                        <div class="form-group ">
                                                                            <div class="row">
                                                                                <div class="col-sm-4">
                                                                                    <label class="control-label" for="id_resep_obat">Id Resep Obat <span class="text-danger">*</span></label>
                                                                                </div>
                                                                                <div class="col-sm-8">
                                                                                    <div class="">
                                                                                        <input id="ctrl-id_resep_obat"  value="<?php  echo $this->set_field_value('id_resep_obat',""); ?>" type="number" placeholder="Enter Id Resep Obat" step="1"  required="" name="id_resep_obat"  class="form-control " />
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group ">
                                                                                <div class="row">
                                                                                    <div class="col-sm-4">
                                                                                        <label class="control-label" for="racikan">Racikan <span class="text-danger">*</span></label>
                                                                                    </div>
                                                                                    <div class="col-sm-8">
                                                                                        <div class="">
                                                                                            <input id="ctrl-racikan"  value="<?php  echo $this->set_field_value('racikan',""); ?>" type="number" placeholder="Enter Racikan" step="1"  required="" name="racikan"  class="form-control " />
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="form-group ">
                                                                                    <div class="row">
                                                                                        ...
                                                                                        <div class="col-sm-8">
                                                                                            <div class="">
                                                                                                <input id="ctrl-id_daftar"  value="<?php  echo $this->set_field_value('id_daftar',""); ?>" type="number" placeholder="Enter Id Daftar" step="1"  required="" name="id_daftar"  class="form-control " />
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                    ...
                                                                                    <div class="form-group ">
                                                                                        <div class="row">
                                                                                            <div class="col-sm-4">
                                                                                                <label class="control-label" for="resep">Resep <span class="text-danger">*</span></label>
                                                                                            </div>
                                                                                            <div class="col-sm-8">
                                                                                                <div class="">
                                                                                                    <input id="ctrl-resep"  value="<?php  echo $this->set_field_value('resep',""); ?>" type="number" placeholder="Enter Resep" step="1"  required="" name="resep"  class="form-control " />
                                                                                                    </div>
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                                        <div class="form-group ">
                                                                                            ...
                                                                                            <div class="form-group ">
                                                                                                <div class="row">
                                                                                                    <div class="col-sm-4">
                                                                                                        <label class="control-label" for="ket_setok">Ket Setok <span class="text-danger">*</span></label>
                                                                                                    </div>
                                                                                                    <div class="col-sm-8">
                                                                                                        <div class="">
                                                                                                            <input id="ctrl-ket_setok"  value="<?php  echo $this->set_field_value('ket_setok',""); ?>" type="text" placeholder="Enter Ket Setok"  required="" name="ket_setok"  class="form-control " />
                                                                                                            </div>
                                                                                                        </div>
                                                                                                    </div>
                                                                                                </div>
