                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <input id="ctrl-rm"  value="<?php  echo $data['rm']; ?>" type="text" placeholder="Enter NO RM LAMA"  name="rm"  data-url="api/json/data_pasien_rm_value_exist/" data-loading-msg="Checking availability ..." data-available-msg="Available" data-unavailable-msg="Not available" class="form-control  ctrl-check-duplicate" />
                                                        <div class="check-status"></div> 
                                                    </div>
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="form-group ">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <div class="">
                                                                    <input id="ctrl-nokk"  value="<?php  echo $data['nokk']; ?>" type="text" placeholder="Enter NOKK"  required="" name="nokk"  class="form-control " />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group ">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <div class="">
                                                                        <input id="ctrl-namaortu"  value="<?php  echo $data['namaortu']; ?>" type="text" placeholder="Enter NAMAORTU"  required="" name="namaortu"  class="form-control " />
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
