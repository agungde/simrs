                        ...
                        <form id="location-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="<?php print_link("location/add?csrf_token=$csrf_token") ?>" method="post">
                            <div>
                                <div class="form-group ">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <label class="control-label" for="id_location">Id Location <span class="text-danger">*</span></label>
                                        </div>
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-id_location"  value="<?php  echo $this->set_field_value('id_location',""); ?>" type="text" placeholder="Enter Id Location"  required="" name="id_location"  class="form-control " />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <input id="ctrl-instansi"  value="<?php  echo $this->set_field_value('instansi',""); ?>" type="text" placeholder="Enter Instansi"  required="" name="instansi"  class="form-control " />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                        ...
                                                        <div class="form-group ">
                                                            ...
                                                            <div class="form-group ">
                                                                ...
                                                                <div class="form-group ">
                                                                    <div class="row">
                                                                        <div class="col-sm-4">
                                                                            <label class="control-label" for="kode_post">Kode Post <span class="text-danger">*</span></label>
                                                                        </div>
                                                                        <div class="col-sm-8">
                                                                            <div class="">
                                                                                <input id="ctrl-kode_post"  value="<?php  echo $this->set_field_value('kode_post',""); ?>" type="text" placeholder="Enter Kode Post"  required="" name="kode_post"  class="form-control " />
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
