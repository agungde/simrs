                                                    ...
                                                    <div class="form-group ">
                                                        ...
                                                        <div class="form-group ">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <div class="">
                                                                        <input id="ctrl-pembayaran"  value="<?php  echo $data['pembayaran']; ?>" type="text" placeholder="Enter Pembayaran"  required="" name="pembayaran"  class="form-control " />
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
