                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <select required=""  id="ctrl-tanggal_lahir" name="tanggal_lahir"  placeholder="Select a value ..."    class="custom-select" >
                                                        <option value="">Select a value ...</option>
                                                        <?php 
                                                        $tanggal_lahir_options = $comp_model -> resep_obat_tanggal_lahir_option_list();
                                                        if(!empty($tanggal_lahir_options)){
                                                        foreach($tanggal_lahir_options as $option){
                                                        $value = (!empty($option['value']) ? $option['value'] : null);
                                                        $label = (!empty($option['label']) ? $option['label'] : $value);
                                                        $selected = $this->set_field_selected('tanggal_lahir',$value, "");
                                                        ?>
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="form-group ">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <div class="">
                                                                    <select required=""  id="ctrl-nama_dokter" name="nama_dokter"  placeholder="Select a value ..."    class="custom-select" >
                                                                        <option value="">Select a value ...</option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="form-group ">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <div class="">
                                                                    <input id="ctrl-pembayaran"  value="<?php  echo $this->set_field_value('pembayaran',""); ?>" type="text" placeholder="Enter Pembayaran"  required="" name="pembayaran"  class="form-control " />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
