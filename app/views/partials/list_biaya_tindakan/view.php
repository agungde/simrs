                            ...
                            <table class="table table-hover table-borderless table-striped">
                                ...
                                <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                    ...
                                    <tr  class="td-nama_tindakan">
                                        ...
                                        <td class="value"> <?php echo $data['nama_tindakan']; ?></td>
                                    </tr>
                                    <tr  class="td-harga">
                                        <th class="title"> Harga: </th>
                                        <td class="value">Rp.<?php echo number_format($data['harga'],0,",",".");?></td>
                                    </tr>
                                    ...
                                    <tr  class="td-kodetarif">
                                        <th class="title"> Kodetarif: </th>
                                        <td class="value"> <?php echo $data['kodetarif']; ?></td>
                                    </tr>
                                </tbody>
                                <!-- Table Body End -->
                            </table>
