...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="edit"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-white p-1 mb-1">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Edit  Diskon Penjualan</h4>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row ">
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("diskon_penjualan/edit/$page_id/?csrf_token=$csrf_token"); ?>" method="post">
                            <div>
                                ...
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-jumlah_minimal"  value="<?php  echo $data['jumlah_minimal']; ?>" type="number" placeholder="Enter Jumlah Minimal" step="1"  name="jumlah_minimal"  class="form-control " />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <input id="ctrl-minimal_total_belanja"  value="<?php  echo $data['minimal_total_belanja']; ?>" type="number" placeholder="Enter Minimal Total Belanja" step="1"  name="minimal_total_belanja"  class="form-control " />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group ">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <input id="ctrl-diskon"  value="<?php  echo $data['diskon']; ?>" type="number" placeholder="Enter Diskon" step="1"  required="" name="diskon"  class="form-control " />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
