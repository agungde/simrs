                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <select required=""  id="ctrl-nama_pelanggan" name="nama_pelanggan"  placeholder="Select a value ..."    class="custom-select" >
                                                        ...
                                                        $selected = $this->set_field_selected('nama_pelanggan',$value, "");
                                                        ?>
                                                            ...
                                                            <div class="form-group ">
                                                                ...
                                                                <div class="form-group ">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-sm-8">
                                                                            <div class="">
                                                                                <input id="ctrl-total_harga_jual"  value="<?php  echo $this->set_field_value('total_harga_jual',""); ?>" type="number" placeholder="Enter Total Harga Jual" step="1"  required="" name="total_harga_jual"  class="form-control " />
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group ">
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-sm-8">
                                                                                <div class="">
                                                                                    <input id="ctrl-total_diskon"  value="<?php  echo $this->set_field_value('total_diskon',""); ?>" type="text" placeholder="Enter Total Diskon"  required="" name="total_diskon"  class="form-control " />
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="form-group ">
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-sm-8">
                                                                                    <div class="">
                                                                                        <input id="ctrl-total_untung"  value="<?php  echo $this->set_field_value('total_untung',""); ?>" type="number" placeholder="Enter Total Untung" step="1"  required="" name="total_untung"  class="form-control " />
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
