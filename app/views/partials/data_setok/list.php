...
$can_add = ACL::is_allowed("data_setok/add");
$can_edit = ACL::is_allowed("data_setok/edit");
$can_view = ACL::is_allowed("data_setok/view");
$can_delete = ACL::is_allowed("data_setok/delete");
?>
<?php
...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="list"  data-display-type="table" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class=" p-2 mb-2">
        <div class="container-fluid">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Data Stok</h4>
                </div>
                <div class="col-sm-4 ">
                    <form  class="search" action="<?php print_link('data_setok'); ?>" method="get">
                            ...
                            <nav class="page-header-breadcrumbs mt-2" aria-label="breadcrumb">
                                <ul class="breadcrumb m-0 p-1">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a class="text-decoration-none" href="<?php print_link('data_setok'); ?>">
