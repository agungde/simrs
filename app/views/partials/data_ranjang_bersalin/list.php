...
$can_add = ACL::is_allowed("data_ranjang_bersalin/add");
$can_edit = ACL::is_allowed("data_ranjang_bersalin/edit");
$can_view = ACL::is_allowed("data_ranjang_bersalin/view");
$can_delete = ACL::is_allowed("data_ranjang_bersalin/delete");
?>
<?php
...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="list"  data-display-type="table" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container-fluid">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Data Ranjang Bersalin</h4>
                </div>
                <div class="col-sm-3 ">
                    <?php if($can_add){ ?>
                    <a  class="btn btn btn-primary my-1" href="<?php print_link("data_ranjang_bersalin/add") ?>">
                        <i class="fa fa-plus"></i>                              
                        Add New Data Ranjang Bersalin 
                    </a>
                    <?php } ?>
                </div>
                <div class="col-sm-4 ">
                    <form  class="search" action="<?php print_link('data_ranjang_bersalin'); ?>" method="get">
                            ...
                            <nav class="page-header-breadcrumbs mt-2" aria-label="breadcrumb">
                                <ul class="breadcrumb m-0 p-1">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a class="text-decoration-none" href="<?php print_link('data_ranjang_bersalin'); ?>">
                ...
                <div class="row ">
                    <div class="col-md-12 comp-grid">
                        ...
                        <div  class=" animated fadeIn page-content">
                            <div id="data_ranjang_bersalin-list-records">
                                <div id="page-report-body" class="table-responsive">
                                    <table class="table  table-sm text-left">
                                        ...
                                        <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                            ...
                                            ?>
                                            <tr>
                                                <td class="td-id"><a href="<?php print_link("data_ranjang_bersalin/view/$data[id]") ?>"><?php echo $data['id']; ?></a></td>
