...
class BaseController{
	...
	function __construct(){
		...
		$this->file_upload_settings['EKG'] = array(
			"title" => "{{random}}",
			"extensions" => ".jpg,.png,.gif,.jpeg",
			"limit" => "5",
			"filesize" => "10",
			"returnfullpath" => false,
			"filenameprefix" => "EKG_",
			"uploadDir" => "uploads/files/ekg/"
		);
	

		$this->file_upload_settings['CTG'] = array(
			"title" => "{{random}}",
			"extensions" => ".jpg,.png,.gif,.jpeg",
			"limit" => "5",
			"filesize" => "10",
		...
		$this->file_upload_settings['hasil_lab'] = array(
			"title" => "{{random}}",
			"extensions" => ".jpg,.png,.gif,.jpeg",
			"limit" => "1",
			"filesize" => "15",
